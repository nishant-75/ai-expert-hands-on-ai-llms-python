...
cv2.circle(image_rgb, (center1_x, center1_y), 15, (0, 255, 0), -1)  # Filled green
cv2.circle(image_rgb, (center2_x, center2_y), 15, (0, 255, 0), -1)  # Filled green

# Step 4: Draw Connecting Line Between Centers
...
cv2.arrowedLine(image_rgb, arrow_start, arrow_end, (255, 255, 0), 3, tipLength=0.05)  # Downward
cv2.arrowedLine(image_rgb, arrow_end, arrow_start, (255, 255, 0), 3, tipLength=0.05)  # Upward

# Annotate the height value at the midpoint of the arrow
